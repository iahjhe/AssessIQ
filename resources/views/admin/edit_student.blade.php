...
@endif
    <form action="{{ route('students.update', $student->id) }}" method="POST" class="bg-gray-800 shadow-md rounded-lg p-6">
        @csrf
        @method('PUT')
    ...
    <a href="{{ route('admin.manage_students') }}" class="text-blue-600 hover:underline">Back to Student Management</a>
</x-app-layout>
